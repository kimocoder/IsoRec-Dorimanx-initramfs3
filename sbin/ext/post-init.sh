...
[ ! -f /data/.siyah/user_profile_1.profile ] && cp -a /res/customconfig/user_profile_1.profile /data/.siyah//user_profile_1.profile;
[ ! -f /data/.siyah/user_profile_2.profile ] && cp -a /res/customconfig/user_profile_2.profile /data/.siyah/user_profile_2.profile;
[ ! -f /data/.siyah/user_profile_3.profile ] && cp -a /res/customconfig/user_profile_3.profile /data/.siyah/user_profile_3.profile;
